...
public class ObjectForkAndJoinSpec {
    ...
    public void testThatExecuteJustAcceptTask() {
        ...
        ObjectForkAndJoin<String> objectForkAndJoin = new ObjectForkAndJoin<String>(new ObjectFunctionChain<String>(object));
    ...
    public void testThatJoinShouldRestoreChain() {
        ...
        assertEquals(objectForkAndJoin.join().extract(), object);
