...
public class ConcurrentIteratorTest {
    ...
    public void testForMultipleThreads() {
        ...
        final TaskStream<Integer> taskStream = new TaskStream<Integer>(new ConcurrentStreamIterator<Integer>(new AbstractStreamIteratorAdapter<Integer>(list.iterator())));
