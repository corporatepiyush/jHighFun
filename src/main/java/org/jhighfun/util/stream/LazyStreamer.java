 ...
 */
public class LazyStreamer<INIT, OBJ> extends AbstractStreamer<OBJ> {
    ...
    public LazyStreamer(INIT initialInput, Function<INIT, Tuple2<INIT, OBJ>> function, Function<INIT, Boolean> predicate) {
